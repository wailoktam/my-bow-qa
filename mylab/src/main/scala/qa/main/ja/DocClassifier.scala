...
/**
 * Created by wailoktam on 15/11/09.
 */
class DocClassifier {

}

class SearchByAnswer(val index_dir: Directory, val maxSearchResults: Int = 100) {
...
object SearchByAnswer {

  def main(args: Array[String]): Unit = {
    if (args.length < 6) {
      System.err.println("Usage: scala qa.main.ja.SearchByAnswer INDEX_DIR INPUT_XML OUTPUT_XML MUST1_OR_SHOULD0 BOOST_TOPIC BOOST_HV")
      System.exit(1)
    }
    // create index
